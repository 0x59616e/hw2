...
main.c:
	...
	g++ -g -c ${MAIN_SRC} -o ${MAIN_OUT}

${COMPILER}: create_build_folder lex.yy.c y.tab.c main.c
	$(info ---------- Create compiler ----------)
	g++ ${CFLAGS} -o ${COMPILER_OUT} -iquote ./ -iquote ../ ${LEX_OUT} ${YAC_OUT} ${MAIN_OUT}
...
myjudge:
	@/root/2024-Spring-NCKU-CompilerHW2/judge.sh
